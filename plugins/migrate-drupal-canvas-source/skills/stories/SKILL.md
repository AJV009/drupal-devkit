...
When building stories for components deployed to Acquia Source, consult the official documentation to understand how props, slots, and component patterns work on the platform. Use the `acquia-source-docs-explorer` skill:

```
/acquia-source-docs-explorer components props slots patterns
```
